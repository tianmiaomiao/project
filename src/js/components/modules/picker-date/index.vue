...
<script>
    ...
    import { toObject } from '../../../lib/core.js'
    ...
    export default {
        ...
        methods: {
                ...
                for (let i = columnIndex, len = columnDataGenerator.length; i < len; i++) {
                    ...
                    for (let j = 0; j < i; j++) {
                        ...
                        if (columnData[j]) {
                            ...
                            console.log(`DatePicker columnData of index ${j} is void`)
                        }
                    }
            ...
            $_generateYearData () {
                ...
                if (start > end) {
                    console.log('MinDate Year should be earlier than MaxDate')
                    return
                }
            ...
            $_generateHourData () {
                ...
                if (start > end) {
                    console.log('MinDate Hour should be earlier than MaxDate')
                    return
                }
