...
(function (window, document, Math) {
  ...
  function DatePicker(params) {
      ...
      //添加click事件
      if(!this.options.dom || !document.getElementById(this.options.dom)){
          this.eventClick();
      }
  }
  ...
  DatePicker.prototype = {
      ...
      FillData: function () {
          var self = this;
          var picker_type = 'fixed';
          var _body = document.body;

          if(self.options.dom && document.getElementById(self.options.dom)){
              picker_type = 'normal';
              _body = document.getElementById(self.options.dom);
          }else{
              // 所有输入失去焦点(隐藏键盘)
              self.enterNodesBlur();
          }
          ...
          if(picker_type == 'normal'){
              modalParent.classList.add('zx_normal');
              picker_list = '<div class="zx_select showPicker"><div class="ub" id="wrapper-parent"><div class="ub-f1 picker-wrapper" id="dp-wrapper0"><ul></ul></div>';
          }
          //2级选择
          ...
          for( var i = 0; i < pickerWrapperArr.length; i++ ){
              pickerWrapperArr[i].style.fontSize = ".38rem";
          ...
          setTimeout(function () {
              self.setValueCallBack();
              if(picker_type == 'fixed') {
                  document.querySelector('.zx_select').style.height = '5.3rem';
              }
          }, 0);
      },
      ...
      getYearList: function (index, defaultValue) {
          ...
          if( defaultValue ){
              ...
              self.setDefaultItem(index, minYear);
          }
      ...
      eventClick: function () {
          ...
          //取消按钮
          document.querySelector('.picker-cancel,.zx_mask').addEventListener("touchstart", function (e) {
              e.stopPropagation();
              e.preventDefault();
              //隐藏picker
              self.HidePicker();
          ...
          document.querySelector('.picker-ok').addEventListener("touchstart", function (e) {
              ...
              //回调函数
              if( self.options.callBack ){
                  self.options.callBack(inputValue,true);
              }
